#include "acoustics_var_rp_step_serial.h"
/**
Implements the serial stepping of the acoustics_var rieman problem through a structured
2D grid.
 ...
 */
void acoustics_var_rp_step_serial(const real* q, const real* aux,
