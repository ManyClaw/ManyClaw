#include "acoustics_const_rp_step_tbb.h"

#include <tbb/parallel_for.h>
#include <tbb/blocked_range2d.h>

struct acoustics_const_rp_step_tbb_body
{
  const real* q;
  const real* aux;
  int nx, ny;
  ...
  acoustics_const_rp_step_tbb_body(const real* q,  const real* aux,
...
void acoustics_const_rp_step_tbb( const real* q,  const real* aux,
                            const int nx, const  int ny,
                            real* amdq, real* apdq, real* wave,
                            real* wave_speeds)
{
  acoustics_const_rp_step_tbb_body body
